...
```
Commit changes.
2. Editar `App.tsx` (ya existe):
En el repo, click en el archivo `App.tsx` → ícono de lápiz (editar) arriba a la derecha → borrá todo el contenido actual y pegá esto en su lugar:
```tsx
